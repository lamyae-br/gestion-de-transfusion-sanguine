...
/* Inputs */
.input-text, .header-searchbar, .box, select {
    padding: 10px;
    border-radius: 6px;
...
/* Hover et effets sur boutons dans le tableau */
.button-icon {
    min-width: 80px;
    text-align: center;
}
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Rechercher un médecin par nom ou email" list="doctors">&nbsp;&nbsp;
...
?>
                ...
                <tr>
                   <td colspan="4">
                     ...
                     <thead>
    <tr>
        <th class="table-headin" style="background:#000000; color:white;">Nom du médecin</th>
<th class="table-headin" style="background:#000000; color:white;">Email</th>
<th class="table-headin" style="background:#000000; color:white;">Spécialités</th>
<th class="table-headin" style="background:#000000; color:white;">Actions</th>
